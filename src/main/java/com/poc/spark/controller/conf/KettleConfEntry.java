...
import static com.poc.spark.controller.conf.RollingTimeInterval.*;
import static com.poc.spark.controller.conf.SchedulingMode.*;
import static com.poc.spark.controller.conf.IntInfinity.*;

/**
 * Created by fcamara
 */
public enum KettleConfEntry implements ConfEntry {
  ...
  private KettleConfEntry(String key, Object defaultValue) {
    this.key = key;
  ...
  public boolean isSparkProperty() {return true;}
}
