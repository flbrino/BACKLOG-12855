...
public class KettleConf extends ClientConf<KettleConf> {
  ...
  private void setKettleDefaults() {
    //SET KETTLE
    set( KettleConfEntry.SPARK_JARS,
    ...
    set( KettleConfEntry.SPARK_EVENTLOG_DIR,
        "hdfs://svqxbdcn6cdh58secure-n2.pentahoqa.com:8020/user/devuser/eventLog" );

    //YARN MODE
    set( KettleConfEntry.SPARK_MASTER, "yarn" );

    //SPARK LIBS
    set( KettleConfEntry.SPARK_YARN_ARCHIVE,
